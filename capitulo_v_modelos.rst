...
**Introducción al modulo todo\_ui**
...
Ahora queremos llevar a nuestra aplicación a otro nivel agregandole una
...
-  ``_table``: Este es el nombre de la tabla de la base de datos que
   ...
   automáticamente, y es el nombre del modelo con el caracter de piso
...
.. figure:: /images/Odoo%20Development%20Essentials%20-%20Daniel%20Reis-185_1.jpg
   :alt: 185\_1
...
*Tip* \* Los formularios del Modelo pueden ser editados! Es posible
...
-  ``auto_join = True``, permite que el ORM use uniones SQL haciendo
   ...
   fijado como False para reforzas las reglas de seguridad. Si son
...
a uno: contexto, dominio, ondelete (aquí actuá en el lado “muchos” de la
...
Debido a que estamos usando el campo ``user_id`` agregado por el modulo
