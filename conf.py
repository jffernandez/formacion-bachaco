...
project = u'odoo'
copyright = u'Daniel Reis, Colaboradores de la iniciativa BachacoVe'
author = u'Daniel Reis, Colaboradores de la iniciativa BachacoVe'
...
github_project = 'formacion-bachaco'
